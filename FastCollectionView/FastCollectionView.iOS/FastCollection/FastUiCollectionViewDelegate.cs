...
namespace Binwell.Controls.FastCollectionView.iOS.FastCollection
{
    public class FastUiCollectionViewDelegate : UICollectionViewDelegateFlowLayout
    {
	    ...
	    public FastUiCollectionViewDelegate(OnScrolled onScrolled, OnGetSizeForItem onGetSizeForItem, Action<CGPoint, ScrollActionType> onScrollStarted, Action<CGPoint, ScrollActionType, bool> onScrollEnded) {
