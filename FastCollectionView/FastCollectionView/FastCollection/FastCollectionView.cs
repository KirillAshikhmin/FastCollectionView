...
namespace Binwell.Controls.FastCollectionView.FastCollection
{
    ...
    public class FastCollectionView : ContentView, IScrollAwareElement, IDisposable
    {
        ...
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(nameof(ItemsSource),
            typeof(IEnumerable), typeof(FastCollectionView));


        public static readonly BindableProperty ItemTemplateSelectorProperty = BindableProperty.Create(nameof(ItemTemplateSelector),
            typeof(FastCollectionTemplateSelector), typeof(FastCollectionView));

        public static readonly BindableProperty RefreshCommandProperty = BindableProperty.Create(
            nameof(RefreshCommand), typeof(ICommand), typeof(FastCollectionView));

        public static readonly BindableProperty LoadMoreCommandProperty =
            BindableProperty.Create(nameof(LoadMoreCommand), typeof(ICommand), typeof(FastCollectionView));

        public static readonly BindableProperty ItemSelectedCommandProperty =
            BindableProperty.Create(nameof(ItemSelectedCommand), typeof(ICommand), typeof(FastCollectionView));

        public static readonly BindableProperty RowSpacingProperty = BindableProperty.Create(nameof(RowSpacing),
            typeof(double), typeof(FastCollectionView), 0.0);

        public static readonly BindableProperty IsScrollEnabledProperty =
            BindableProperty.Create(nameof(IsScrollEnabled), typeof(bool), typeof(FastCollectionView), true);
        ...
        public static readonly BindableProperty ContentPaddingLeftProperty =
            BindableProperty.Create(nameof(ContentPaddingLeft), typeof(double), typeof(FastCollectionView), 0.0);

        public static readonly BindableProperty ContentPaddingRightProperty =
            BindableProperty.Create(nameof(ContentPaddingRight), typeof(double), typeof(FastCollectionView), 0.0);

        public static readonly BindableProperty ContentPaddingBottomProperty =
            BindableProperty.Create(nameof(ContentPaddingBottom), typeof(double), typeof(FastCollectionView), 0.0);

        public static readonly BindableProperty SectionPaddingLeftProperty =
            BindableProperty.Create(nameof(SectionPaddingLeft), typeof(double), typeof(FastCollectionView), default(double),
                BindingMode.Default);

        public static readonly BindableProperty SectionPaddingBottomProperty =
            BindableProperty.Create(nameof(SectionPaddingBottom), typeof(double), typeof(FastCollectionView), 0.0);

        public static readonly BindableProperty SectionPaddingTopProperty =
            BindableProperty.Create(nameof(SectionPaddingTop), typeof(double), typeof(FastCollectionView), 0.0);

        public static readonly BindableProperty ContentPaddingTopProperty =
            BindableProperty.Create(nameof(ContentPaddingTop), typeof(double), typeof(FastCollectionView), 0.0);
        ...
        public static readonly BindableProperty IsPullToRefreshEnabledProperty =
            BindableProperty.Create(nameof(IsPullToRefreshEnabled), typeof(bool), typeof(FastCollectionView), false);
        ...
        public FastCollectionTemplateSelector ItemTemplateSelector
        {
            get => (FastCollectionTemplateSelector) GetValue(ItemTemplateSelectorProperty);
        ...
        public void InvokeItemSelectedEvent(object sender, object item)
        {
            ...
            ItemSelected?.Invoke(sender, new FastCollectionEventArgs<object>(item));
        }
